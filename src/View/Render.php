...
class Render
{
    ...
    {
        //monta o caminho do local onde o bloco localizado está
        ...
        //iniciamos a captura do buffer para não printar ao usuário o conteúdo do arquivo que será requerido
        ob_start();
